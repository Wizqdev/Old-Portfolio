            ...
            projects ? (
              projects.map((_, __) => (
                <a target="_blank" rel="noreferrer" key={__} className="bg-neutral-800/10 p-4 hover:bg-neutral-800/20 shadow-lg hover:shadow-xl transition-all duration-200 rounded-lg w-full">
                  <img alt="Prajwal" src={_.image} width="1024" className="rounded-lg" height="512" />
                  ...
                  <div>
                  <a href={_.github} target="_blank">
                  <button style={{ color: 'White' }} >Github</button>
                  </a>    
                  </div>
                  <div>
                  <a href={_.live} target="_blank">
                  <button style={{ color: 'Green' }} >Live</button>
                  </a>
                  </div>
              </a>
              ))
